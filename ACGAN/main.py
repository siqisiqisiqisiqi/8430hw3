...
for epoch in range(1, epochs + 1):
    ...
    torch.save(gen.state_dict(), 'weights/netG_epoch_%d.pth' % (epoch))
    torch.save(disc.state_dict(), 'weights/netD_epoch_%d.pth' % (epoch))


dict_data = {'G_losses': G_losses, "D_losses": D_losses}
